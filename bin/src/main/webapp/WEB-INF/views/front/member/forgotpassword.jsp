...
<body>
	...
	<form:form action="${pageContext.request.contextPath}/member/editPassword" method="get" modelAttribute="editPassword">
        
        <h1 class="text-dark">忘記密碼</h1>
        <form method="post" action="login.js">
            <p>請輸入email及手機號碼，我們將向您發送電子郵件以重置密碼。</p>
            <div>
                <input type="email" class="text-field-Register" name="email" id="email" placeholder="電子郵件"
            ...
            <div>
                <a href="${pageContext.request.contextPath}/member/editPassword?email=${editPassword.email}&phone=${editPassword.phone}" id="btn-login" class="btn-primary text-dark" value="提交"
